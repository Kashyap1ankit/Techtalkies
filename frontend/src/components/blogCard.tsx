...
export default function BlogCard(props: propsType) {
  ...
  return (
    <div className=" w-2/3 mx-auto shadow-md bg-white mb-12 xl:px-4 xl:py-6 rounded-md cursor-pointer">
      {/* --Upper Part--- */}
      <div className="flex justify-start ">
        <div className="xl:mr-12 w-1/8 text-center">
          <img className="xl:size-10 mx-auto" src={Profile} alt="" />
          <Title text={props.author} className="text-gray mt-4 font-intro" />
        </div>
        ...
        <div className="w-2/3">
          ...
          />
          <Title text={props.des} className="text-sm  tracking-wide" />
        </div>
      </div>
